...
public class TimelineHelper : SingletonMono<TimelineHelper> {
  private Dictionary<PlayableDirector, Action<bool>> AnimCallbacks = new Dictionary<PlayableDirector, Action<bool>>();
  private Dictionary<PlayableDirector, Action<bool>> CompletedAnimCallbacks = new Dictionary<PlayableDirector, Action<bool>>();
